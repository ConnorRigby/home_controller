defmodule HomeController.MySensors.Web.LanApp.ResourceSocket do
  @moduledoc """
  Lan App WebSocket Server for MySensors Resources.
  On initialization, this module subscribes to [MySensors.Broadcast]("HomeController.MySensors.Broadcast.html").
