defmodule HomeController.MySensors.BroadcastTest do
  alias HomeController.MySensors.{Context, Broadcast, Node}
  use ExUnit.Case, async: false

  doctest Broadcast

  setup do
    :ok = Ecto.Adapters.SQL.Sandbox.checkout(HomeController.MySensors.Repo, ownership_timeout: :infinity)
